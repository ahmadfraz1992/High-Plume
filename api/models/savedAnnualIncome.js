...
const savedAnnualIncomeSchema = new Schema({
  savedAnnualIncomeId: {
    type: Number,
    autoIncrement: true,
    primaryKey: true
...
savedAnnualIncomeSchema.plugin(autoIncrement.plugin, "savedAnnualIncome");
var savedAnnualIncome = mongoose.model(
  "savedAnnualIncome",
  savedAnnualIncomeSchema
);

module.exports = mongoose.model("savedAnnualIncome", savedAnnualIncomeSchema);
