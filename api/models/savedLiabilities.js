...
const savedLiabilitiesSchema = new Schema({
  savedLiabilitiesId: {
    type: Number,
    autoIncrement: true,
    primaryKey: true
...
savedLiabilitiesSchema.plugin(autoIncrement.plugin, "savedLiabilities");
var savedLiabilities = mongoose.model(
  "savedLiabilities",
  savedLiabilitiesSchema
);

module.exports = mongoose.model("savedLiabilities", savedLiabilitiesSchema);
