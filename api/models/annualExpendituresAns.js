...
const annualExpendituresAnsSchema = new Schema({
  Ans_id: {
    type: Number,
    autoIncrement: true,
    primaryKey: true
...
annualExpendituresAnsSchema.plugin(
  autoIncrement.plugin,
  "annualExpendituresAns"
);
var annualExpendituresAns = mongoose.model(
  "annualExpendituresAns",
  annualExpendituresAnsSchema
);
