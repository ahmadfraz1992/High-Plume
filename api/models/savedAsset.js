...
const savedAssetSchema = new Schema({
  savedAssetId: {
    type: Number,
    autoIncrement: true,
    primaryKey: true
...
savedAssetSchema.plugin(autoIncrement.plugin, "savedAsset");
var savedasset = mongoose.model("savedAsset", savedAssetSchema);

module.exports = mongoose.model("savedAsset", savedAssetSchema);
