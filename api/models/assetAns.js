...
const assetAnsSchema = new Schema({
  Ans_id: {
    type: Number,
    autoIncrement: true,
    primaryKey: true
...
assetAnsSchema.plugin(autoIncrement.plugin, "assetAns");
var assetAns = mongoose.model("assetAns", assetAnsSchema);

module.exports = mongoose.model("assetAns", assetAnsSchema);
