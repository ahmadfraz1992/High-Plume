...
const savedStartupQuestionsSchema = new Schema({
  savedStartupId: {
    type: Number,
    autoIncrement: true,
    primaryKey: true
...
savedStartupQuestionsSchema.plugin(
  autoIncrement.plugin,
  "savedStartupQuestions"
);
var savedStartup = mongoose.model(
  "savedStartupQuestions",
  savedStartupQuestionsSchema
);

module.exports = mongoose.model("savedstartups", savedStartupQuestionsSchema);
