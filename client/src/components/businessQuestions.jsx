...
var businessQuestiondescription = [];
var businessQuestionId = [];
var data;
var cat_id;
function showLoader() {
  $(".overlay").show();
...
class businessQuestions extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get("http://localhost:6006/categoryInfo/getcategoryInfo", userData)
      .then(response => {
    ...
    showLoader();
    axios
      .get("http://localhost:6006/businessQuestions/getbusinessQuestions")
      .then(response => {
        //console.log(response);
        questions_from_db = response.data.businessLocalData;
  ...
  onSubmit1(e) {
    ...
    axios
      .post(
        "http://localhost:6006/businessQuestions/addbusinessQuestions",
        userData
      )
      .then(response => {
        hideLoader();
  ...
  onSubmit() {
    ...
    $("#undo_redo_to > option").each(function() {
      businessQuestiondescription[index] = $(this).text();
      businessQuestionId[index] = $(this).val();
      index = index + 1;
      console.log(businessQuestiondescription);
      console.log(businessQuestionId);
    });

    for (let i = 0; i < businessQuestiondescription.length; i++) {
      debugger;
      const userData = {
        cat_id: cat_id,
        q_desc: businessQuestiondescription[i],
        q_Id: businessQuestionId[i]
      };
      axios
        .post(
          "http://localhost:6006/savedBusinessQuestions/savedBusinessQuestions",
          userData
        )
        .then(response => {
          console.log(response);
  ...
  render() {
    ...
    return (
      <div style={{ paddingTop: "5%" }} className="container">
        ...
        <h1 style={{ fontSize: "55px" }}>Business Questions</h1>
