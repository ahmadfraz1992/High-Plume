...
var liabilitiesQuestiondescription = [];
var liabilitiesQuestionId = [];
var data;
var cat_id;
function showLoader() {
  $(".overlay").show();
...
class asset extends Component {
  ...
  componentDidMount() {
    ...
    //  showLoader();
    axios
      .get("http://localhost:6007/liabilities/getLiabilitiesInformation")
      .then(response => {
        //console.log(response);
        questions_from_db = response.data.liabilitiesLocalData;
  ...
  onSubmit1(e) {
    ...
    axios
      .post(
        "http://localhost:6007/liabilities/addLiabilitiesInformation",
        userData
      )
      .then(response => {
        //  hideLoader();
  ...
  onSubmit() {
    ...
    $("#undo_redo_to > option").each(function() {
      liabilitiesQuestiondescription[index] = $(this).text();
      liabilitiesQuestionId[index] = $(this).val();
      index = index + 1;
      console.log(liabilitiesQuestiondescription);
      console.log(liabilitiesQuestionId);
    });

    for (let i = 0; i < liabilitiesQuestiondescription.length; i++) {
      debugger;
      const userData = {
        cat_id: cat_id,
        q_desc: liabilitiesQuestiondescription[i],
        q_Id: liabilitiesQuestionId[i]
      };
      axios
        .post(
          "http://localhost:6007/savedliabilities/savedLiabilities",
          userData
        )
        .then(response => {
          console.log(response);
