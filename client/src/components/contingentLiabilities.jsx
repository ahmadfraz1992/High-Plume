...
var contingentLiabilitiesQuestiondescription = [];
var contingentLiabilitiesQuestionId = [];
var data;
var cat_id;
function showLoader() {
  $(".overlay").show();
...
class contingentLiabilities extends Component {
  constructor() {
    super();
    this.state = {
      questions: [],
  ...
  componentDidMount() {
    ...
    axios
      .get(
        "http://localhost:6007/contingentLiabilities/getcontingentLiabilitiesInformation"
      )
      .then(response => {
        //console.log(response);
        questions_from_db = response.data.contingentLiabilitiesLocalData;
  ...
  onSubmit1(e) {
    ...
    axios
      .post(
        "http://localhost:6007/contingentLiabilities/addcontingentLiabilitiesInformation",
        userData
      )
      .then(response => {
        //  hideLoader();
  ...
  onSubmit() {
    ...
    $("#undo_redo_to > option").each(function() {
      contingentLiabilitiesQuestiondescription[index] = $(this).text();
      contingentLiabilitiesQuestionId[index] = $(this).val();
      index = index + 1;
      console.log(contingentLiabilitiesQuestiondescription);
      console.log(contingentLiabilitiesQuestionId);
    });

    for (let i = 0; i < contingentLiabilitiesQuestiondescription.length; i++) {
      debugger;
      const userData = {
        cat_id: cat_id,
        q_desc: contingentLiabilitiesQuestiondescription[i],
        q_Id: contingentLiabilitiesQuestionId[i]
      };
      axios
        .post(
          "http://localhost:6007/savedContingentLiabilities/savedContingentLiabilities",
          userData
        )
        .then(response => {
          console.log(response);
  ...
  render() {
    ...
    return (
      <div style={{ paddingTop: "5%" }} className="container">
        ...
        <h1 style={{ fontSize: "55px" }}>Contingent Liabilities</h1>
